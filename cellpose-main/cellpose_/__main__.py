...
def main():
    """ Run cellpose_ from command line
    """
    ...
    if len(args.dir) == 0 and len(args.image_path) == 0:
        if args.add_model:
            ...
            if not GUI_ENABLED:
                ...
                if GUI_IMPORT:
                    ...
                    print("     pip install 'cellpose_[gui]'")
            else:
                if args.Zstack:
                    gui3d.run()
                else:
        ...
        if args.verbose:
            ...
            print(
                ">>>> !LOGGING OFF BY DEFAULT! To see cellpose_ progress, set --verbose")
        ...
        if not args.train and not args.train_size:
            ...
            logger.info(
                ">>>> running cellpose_ on %d images using chan_to_seg %s and chan (opt) %s"
