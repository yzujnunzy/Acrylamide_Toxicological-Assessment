...
def get_arg_parser():
    """ Parses command line arguments for cellpose_ main function
    ...
    parser.add_argument("--version", action="store_true",
                        help="show cellpose_ version info")
    parser.add_argument(
    ...
    model_args.add_argument(
        ...
        help="model path to copy model to hidden .cellpose_ folder for using in GUI/CLI")
