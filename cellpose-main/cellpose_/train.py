...
def train_seg(net, train_data=None, train_labels=None, train_files=None,
    ...
    Args:
        ...
        test_labels (List[np.ndarray], optional): List of arrays (2D or 3D) - labels for test_data_densenet, where 0=no masks; 1,2,...=mask labels. Defaults to None.
        test_files (List[str], optional): List of strings - file names for images in test_data_densenet (to save flows for future runs). Defaults to None.
